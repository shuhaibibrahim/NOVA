...
function StockEntry() {
    ...
    useEffect(() => {
        setSelectedLink("admin/stock-entry")
    ...
    const RenderItem=(item, index)=>{
        ...
        return (
            ...
            <div key={index} className="grid grid-cols-8 gap-x-1 border-solid border-b border-gray-400 p-3 bg-gray-200" >
                {item.edit!=true&&(<>
                    
                    <div className="text-stone-900/30 break-all text-left">{item.materialNumber}</div>

                    <div className="text-stone-900/30 break-all text-left">{item.materialName}</div>

                    <div className="text-stone-900/30 break-all text-left">{item.storeStock}</div>

                    <div className="text-stone-900/30 break-all text-left">{item.productionStock}</div>
                    ...
                    <div className="flex w-full flex flex-col items-start justify-start">
                        <input 
                            ...
                            onChange={e=>{
                                ...
                                setEditData({
                                    ...editData,
                                    productionStock: e.target.value
                                })
                            }}
                            type="text" 
                            className='w-full ring-2 p-1 ring-blue-200 focus:outline-none focus:ring-blue-500 rounded'
    ...
    return (
        <div className="pb-2 bg-blue-50 h-full px-3 pt-4">
            ...
            <div className="flex flex-col h-xlg space-y-2 items-center justify center items-center bg-white rounded p-4">
                ...
                <div className="w-full sticky top-0 p-3 grid grid-cols-8 gap-1 bg-gray-200">
                    <div className="text-sm py-2 text-left">MATERIAL NUMBER</div>
                    <div className="text-sm py-2 text-left">MATERIAL NAME</div>
                    <div className="text-sm py-2 text-left">STORE STOCK</div>
                    <div className="text-sm py-2 text-left">PRODUCTION STOCK</div>
