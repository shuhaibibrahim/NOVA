                ...
                <div className='mt-6 space-y-2 flex flex-col items-start w-full justify-start'>
                    ...
                    <div className='text-sm flex space-x-2 items-center'>
                        <Link to="../knitting-plan" > 
                            <span className='text-black opacity-70 cursor-pointer hover:opacity-100'>Knitting Planning Sheet</span> 
                        </Link>
...
export default PreviousKnittingPlan
