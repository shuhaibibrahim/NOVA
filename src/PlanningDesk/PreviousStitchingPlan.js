...
function PreviousStitchingPlan() {
            ...
            <div className="h-5/12 pt-6 pb-6 flex flex-col items-center filter drop-shadow-lg">
                ...
                <div className='mt-6 space-y-2 flex flex-col items-start w-full justify-start'>
                    ...
                    <div className='text-sm flex space-x-2 items-center'>
                        <Link to="../stitching-plan" > 
                            <span className='text-black opacity-70 cursor-pointer hover:opacity-100'>Stitching Planning Sheet</span> 
                        </Link>
...
export default PreviousStitchingPlan
